...
const Content = ({ align = 'right', className = 'w-48', contentClasses = 'py-1 bg-white', children }: PropsWithChildren<{ align?: 'left' | 'right', width?: '48', className?: string, contentClasses?: string }>) => {
